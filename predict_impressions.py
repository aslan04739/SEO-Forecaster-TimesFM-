...
COLONNE_A_PREDIRE = 'Impressions'  # Exemple: 'Clicks' ou 'Impressions'
...
df_result.to_csv('resultat_prediction_Impressions.csv', index=False)
print("\nLes résultats ont été sauvegardés dans 'resultat_prediction_Impressions.csv'")
...
plt.tight_layout()
plt.savefig('Impressions.png', dpi=150)
print("La figure a été sauvegardée dans 'Impressions.png'.")