...
COLONNE_A_PREDIRE = 'CTR'  # Exemple: 'Clicks' ou 'Impressions'
...
df_result.to_csv('resultat_prediction_CTR.csv', index=False)
print("\nLes résultats ont été sauvegardés dans 'resultat_prediction_CTR.csv'")
...
plt.tight_layout()
plt.savefig('CTR.png', dpi=150)
print("La figure a été sauvegardée dans 'CTR.png'.")