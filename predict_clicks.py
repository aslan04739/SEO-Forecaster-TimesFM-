...
COLONNE_A_PREDIRE = 'Clicks'  # Exemple: 'Clicks' ou 'Impressions'
...
df_result.to_csv('resultat_prediction_Clicks.csv', index=False)
print("\nLes résultats ont été sauvegardés dans 'resultat_prediction.csv'")
...
print("La figure a été sauvegardée dans 'Clicks.png'.")